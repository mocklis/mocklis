    ...
    public class TextWriterLogContext : ILogContext
    {
        ...
        public void LogBeforeEventAdd(MemberMock memberMock)
        {
            _textWriter.WriteLine(
                Invariant($"Adding event handler to '[{memberMock.MocklisClassName}] {memberMock.InterfaceName}.{memberMock.MemberName}'"));
        }

        public void LogAfterEventAdd(MemberMock memberMock)
        {
            _textWriter.WriteLine(Invariant(
        ...
        {
            _textWriter.WriteLine(
                Invariant($"Done setting value on '[{memberMock.MocklisClassName}] {memberMock.InterfaceName}.{memberMock.MemberName}'"));
        }
        ...
        {
            _textWriter.WriteLine(Invariant($"Calling '[{memberMock.MocklisClassName}] {memberMock.InterfaceName}.{memberMock.MemberName}'"));
        }
        ...
        {
            _textWriter.WriteLine(
                Invariant($"Returned from '[{memberMock.MocklisClassName}] {memberMock.InterfaceName}.{memberMock.MemberName}'"));
        }
        ...
        {
            _textWriter.WriteLine(
                Invariant($"Getting value from '[{memberMock.MocklisClassName}] {memberMock.InterfaceName}.{memberMock.MemberName}'"));
        }
