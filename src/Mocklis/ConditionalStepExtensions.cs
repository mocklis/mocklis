...
namespace Mocklis
{
    ...
    public static class ConditionalStepExtensions
    {
        public static IEventStepCaller<THandler> If<THandler>(
            ...
            Action<IEventStepCaller<THandler>, IEventStep<THandler>> branch) where THandler : Delegate
        {
        ...
        public static IIndexerStepCaller<TKey, TValue> If<TKey, TValue>(
            ...
            Action<IIndexerStepCaller<TKey, TValue>, IIndexerStep<TKey, TValue>> branch)
        {
        ...
        public static IMethodStepCaller<TParam, TResult> If<TParam, TResult>(
            ...
            Action<IMethodStepCaller<TParam, TResult>, IMethodStep<TParam, TResult>> ifBranch)
        {
        ...
        public static IMethodStepCaller<TParam, TResult> InstanceIf<TParam, TResult>(
            ...
            Action<IMethodStepCaller<TParam, TResult>, IMethodStep<TParam, TResult>> ifBranch)
        {
            return caller.SetNextStep(new InstanceIfMethodStep<TParam, TResult>(condition, ifBranch));
        }
        ...
        public static IPropertyStepCaller<TValue> If<TValue>(
            ...
            Action<IPropertyStepCaller<TValue>, IPropertyStep<TValue>> branch)
        {
