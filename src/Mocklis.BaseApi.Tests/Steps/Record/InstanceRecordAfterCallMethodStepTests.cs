// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InstanceRecordAfterCallMethodStepTests.cs">
...
namespace Mocklis.Steps.Record
{
    ...
    public class InstanceRecordAfterCallMethodStepTests
    {
        private readonly MockMembers _mockMembers;
        private readonly IMethods _methods;

        public InstanceRecordAfterCallMethodStepTests()
        {
