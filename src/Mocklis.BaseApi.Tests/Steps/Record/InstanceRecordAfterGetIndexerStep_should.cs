// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InstanceRecordAfterGetIndexerStep_should.cs">
...
namespace Mocklis.Steps.Record
{
    ...
    public class InstanceRecordAfterGetIndexerStep_should
    {
        private readonly MockMembers _mockMembers;
        private readonly IIndexers _indexers;

        public InstanceRecordAfterGetIndexerStep_should()
        {
