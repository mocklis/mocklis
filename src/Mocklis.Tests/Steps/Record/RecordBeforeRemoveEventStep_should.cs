// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RecordBeforeRemoveEventStep_should.cs">
...
namespace Mocklis.Tests.Steps.Record
{
    ...
    public class RecordBeforeRemoveEventStep_should
    {
        ...
        public RecordBeforeRemoveEventStep_should()
        {
        ...
        public void RequireSelector()
        {
            ...
            {
                _mockMembers.MyEvent.RecordBeforeRemove(out IReadOnlyList<int> _, null!);
            });
        ...
        {
            // Arrange
            _mockMembers.MyEvent.RecordBeforeRemove(out var ledger)
                .Times(1, a => a.Dummy())
        ...
        public void RecordParameterAndExceptionsUsingSelectors()
        {
            ...
            _mockMembers.MyEvent
                .RecordBeforeRemove(out var ledger, GenericRecord<EventHandler?>.One)
                .Times(1, a => a.Dummy())
                .Throw(_ => new Exception("Exception thrown!"));
