// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InstanceRecordBeforeAddEventStep_should.cs">
...
namespace Mocklis.Tests.Steps.Record
{
    ...
    public class InstanceRecordBeforeAddEventStep_should
    {
        ...
        public InstanceRecordBeforeAddEventStep_should()
        {
