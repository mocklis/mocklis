// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InstanceRecordAfterGetPropertyStep_should.cs">
...
namespace Mocklis.Tests.Steps.Record
{
    ...
    public class InstanceRecordAfterGetPropertyStep_should
    {
        private readonly MockMembers _mockMembers;
        private readonly IProperties _properties;

        public InstanceRecordAfterGetPropertyStep_should()
        {
