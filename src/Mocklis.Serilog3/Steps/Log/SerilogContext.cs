...
namespace Mocklis.Steps.Log
{
    ...
    public class SerilogContext : ILogContext
    {
        ...
        {
            _logger.Write(_normalLogLevel,
                "Calling [{MocklisClassName:l}] {InterfaceName:l}.{MemberName:l} with parameter(s): {param}", mockInfo.MocklisClassName,
        ...
        {
            _logger.Write(_normalLogLevel,
                "Returned from [{MocklisClassName:l}] {InterfaceName:l}.{MemberName:l} with result(s): {result}", mockInfo.MocklisClassName,
