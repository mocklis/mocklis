...
namespace Mocklis.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to No mock implementation found for Method &apos;{1}.{2}&apos;. Add one by subclassing &apos;{0}&apos; and overriding the &apos;{3}&apos; method..
        /// </summary>
        internal static string MockMissingExceptionMessageForVirtualMethod {
            get {
                return ResourceManager.GetString("MockMissingExceptionMessageForVirtualMethod", resourceCulture);
            }
        }
