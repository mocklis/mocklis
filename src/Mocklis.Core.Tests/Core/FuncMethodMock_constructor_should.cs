...
namespace Mocklis.Core.Tests.Core
{
    ...
    public class FuncMethodMock_constructor_should
    {
        ...
        public void set_properties_X28parameterLessX29()
        {
            ...
            var propertyMock = new FuncMethodMock<string>(mockInstance, "MocklisClassName", "InterfaceName", "MemberName", "MemberMockName");
        ...
        {
            var mockInstance = new object();
            var propertyMock = new FuncMethodMock<int, string>(mockInstance, "MocklisClassName", "InterfaceName", "MemberName", "MemberMockName");
            Assert.Equal(mockInstance, propertyMock.MockInstance);
            Assert.Equal("MocklisClassName", propertyMock.MocklisClassName);
            Assert.Equal("InterfaceName", propertyMock.InterfaceName);
            Assert.Equal("MemberName", propertyMock.MemberName);
